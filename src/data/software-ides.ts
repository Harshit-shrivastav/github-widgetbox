...
const softwareIDEs: IconData[] = [
    ...
    },
    {
        ...
        <path d="M30,20 L70,50 L30,80 Z" fill="white"/>
        </svg>`,
        width: 36,
        height: 36,
        xOffset: 0,
    },
    {
        ...
        colorTo: '#357ABD',
        icon: `<svg width="36" height="36" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <path d="M20,20 L80,50 L20,80 Z" fill="white"/>
        </svg>`,
        width: 36,
        height: 36,
        xOffset: 0,
    },
    {
        ...
        colorTo: '#333333',
        icon: `<svg width="36" height="36" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <polygon points="10,90 50,10 90,90" stroke="white" fill="none" stroke-width="10"/>
        </svg>`,
        width: 36,
        height: 36,
        xOffset: 0,
    ...
    },
    {
        ...
        colorTo: '#2A2A2A',
        icon: `<svg width="36" height="36" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <text x="10" y="50" fill="white" font-size="40">IJ</text>
        </svg>`,
        width: 36,
        height: 36,
        xOffset: 0,
    },
    {
        ...
        colorTo: '#6A6A6A',
        icon: `<svg width="36" height="36" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <text x="10" y="50" fill="white" font-size="40">PC</text>
        </svg>`,
        width: 36,
        height: 36,
        xOffset: 0,
